      ...
      <div className="">
        ...
        <div id="in-progress" className={`${styles.section} flex`}>
          <div className={`${styles.vsplit}`}>
            ...
            <div className="pt-5">
              <a href="/designs" className="flex justify-center ">
                <button className={`bg-[#835f02] focus:ring-1 focus-outline-none ring-[white] shadow-sm shadow-[#835f02]/50 rounded-lg text-sm px-5 py-2.5 text-center hover:scale-105 hover:ring-2 transistion duration-200 font-semibold`}>
